        ...
        <div class="right_content">
            ...
            <div class="main_content">
                ...
                <input type="hidden" id="task-id" name="task-id" value="<?php echo (isset($_GET['taskId']) ? htmlspecialchars($_GET['taskId']) : ''); ?>" />
                    ...
                    $attachmentSO = null;
                    $statusSO = null;
                    $sql = "SELECT reportSO, attachmentSO, statusSO, reportSup FROM Report WHERE taskId = ? AND userId = ?";
                    $statement = mysqli_stmt_init($conn);
                    if (mysqli_stmt_prepare($statement, $sql)) {
                        mysqli_stmt_bind_param($statement, 'ii', $taskId, $userId);
                        if (mysqli_stmt_execute($statement)) {
                            mysqli_stmt_bind_result($statement, $reportSO, $attachmentSO, $statusSO, $reportSup);
                    ...
                    <div class="<?php echo $statusSO == 'Completed' ? 'readOnly' : 'labelAndTextarea' ?>">
